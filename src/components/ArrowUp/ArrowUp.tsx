...
const ArrowUp: FC<IArrowUp> = (props): JSX.Element => {
    const { onClick, isUpPosition } = props;
    return (
        <span className={isUpPosition ? cn(styles.arrow_icon, styles.arrow_icon_up) : cn(styles.arrow_icon, styles.arrow_icon_down)} onClick={onClick}>
